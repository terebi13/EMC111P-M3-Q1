...
function outdoorFurniture(){
    ...
    const plantsPotTexture = new THREE.TextureLoader().load("./Assests/textures/wooden.png");
    const plantsPotMaterial = new THREE.MeshLambertMaterial({map : plantsPotTexture});
    ...
    const plantsTexture = new THREE.TextureLoader().load("./Assests/textures/plants.jpg");
...
function outdoorPool(){
    ...
    // const poolFrameTexture = new THREE.TextureLoader().load("./Assests/textures/woodDeck.jpg");
    // const poolFrameMaterial = new THREE.MeshLambertMaterial({map : poolFrameTexture});
